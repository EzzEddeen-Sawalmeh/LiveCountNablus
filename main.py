...
stream = CamGear(source='https://flu.systemnet.tv/mix44/index.m3u8', stream_mode=True, logging=True).start()
...
while True:
    ...
    godown=len(gnd)       
    goup=len(gnu)
    cvzone.putTextRect(frame, f'to Asira: {godown}', (50, 60), 2, 2)
    cvzone.putTextRect(frame, f'to Itehad: {goup}', (50, 160), 2, 2)
